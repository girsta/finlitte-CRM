    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="p-6 space-y-4">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1">Konfigūruojama per aplinkos kintamuosius.</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-500 mt-1">Konfigūruoti el. pašto įspėjimus apie besibaigiančias sutartis.</p>
        </div>
        <div className="p-6">
          <div className="flex items-center gap-3 p-4 bg-yellow-50 text-yellow-800 rounded-lg">
            <Shield size={20} />
            <span>SMTP konfigūracija bus prieinama kitame atnaujinime.</span>
          </div>
        </div>
      </div>
